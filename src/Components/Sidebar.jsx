...
const handleLogout = async()=>{
  ...
  return (
    ...
    <div className='bg-white h-[94vh] w-56 flex flex-col m-4 rounded-4xl shadow-xl'>
      ...
      <div className={`flex items-center gap-3 mb-1 pl-3 h-10  cursor-pointer ${activeTab === "dashboard" ? "bg-amber-300" :"hover:bg-amber-200" }`} onClick={() => setActiveTab("dashboard")}>
      ...
      <div className={`flex items-center gap-3 mb-1 pl-4 h-10 hover:bg-amber-200 duration-100 transition-all cursor-pointer ${activeTab === "task"?"bg-amber-300":"hover:bg-amber-200"} `}onClick={() => setActiveTab("task")}>
